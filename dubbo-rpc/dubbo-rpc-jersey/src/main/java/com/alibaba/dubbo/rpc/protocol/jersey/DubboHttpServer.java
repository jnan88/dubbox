 ...
 * @author lishen
 */
public class DubboHttpServer extends JerseyBaseRestServer {

	private final JerseyConfig config = new JerseyConfig();
	...
	protected void doStart(URL url) {
		...
		servletContext = ServletManager.getInstance().getServletContext(url.getPort());
	...
	protected JerseyConfig getResourceConfig() {
		return config;
	}
